...
review* below is where anything found since goes. Both entries there (F24, F25)
were found and fixed within a day of each other, by running the platform rather
than by reading it.
